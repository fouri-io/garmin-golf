...
- Doubles+ /18: 5.9 → 4.8 (improving)
- 3-putts /18: 1.9 → 2.6 (worse)
- GIR %: 26.1 → 26.7 (flat)
- Bogey-or-better %: 67.2 → 73.3 (improving)

## What to focus on
1. Approach distance + start line: take one more club and start it left of target on mid-irons.  _(78% of 348 mid-iron approaches finish short, 44% miss right; GIR is 26.7%.)_
2. Biggest strokes leak right now: Inside 50.  _(-7.9 strokes per 18 vs scratch over your last 10 clean rounds — the worst of your five SG buckets.)_
3. Annotate more rounds — the process layer is your differentiator and it's running on minimal context.  _(Clean-2nd-shot, recovery and normal-approach metrics currently cover 1 annotated round; 3–5 makes them trendable.)_
