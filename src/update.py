...
from . import (analyze, benchmarks, coach, db, derive, export_rounds, ingest, insights,
               ladder, progress, pull, site)
...
def main() -> None:
    ...
    ladder.build()          # before insights, which ranks its findings
    progress.build()
    benchmarks.build()
    insights.build()
